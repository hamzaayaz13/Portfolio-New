...
export const DraggableContainer = ({
  ...
  useLayoutEffect(() => {
    ...
    let removeX: (() => void) | undefined;
    let removeY: (() => void) | undefined;
    ...
    const attach = () => {
      ...
      removeX = x.on("change", (latest) => {
        x.set(wrap(minX, 0, latest));
      });

      removeY = y.on("change", (latest) => {
        y.set(wrap(minY, 0, latest));
      });
      ...
      removeWheel = () => window.removeEventListener("wheel", handleWheelScroll);
    };
